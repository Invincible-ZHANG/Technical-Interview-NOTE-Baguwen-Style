...
## [Week 19](./MA_WP_CH/WP19.md)   Time:15.09.2025 - 19.09.2025
...
## [Week 20](./MA_WP_CH/WP20.md)   Time:22.09.2025 - 26.09.2025
...
## [Week 22](./MA_WP_CH/WP22.md)   Time:06.10.2025 - 10.10.2025
...
## [Week 25](./MA_WP_CH/WP25.md)   Time:27.10.2025 - 31.10.2025

- [ ] 进行算子化设计（维度出问题了）
- [x] 安装不同的引擎（chrono测试 + jolt安装）
- [x] 修改求解器顺序的问题
- [ ] 关于求解器部分代码QT界面的实现
- [ ] 写一个extension
- [ ] 伐木车模型？
...
## [Week 26](./MA_WP_CH/WP26.md)   Time:3.11.2025 - 7.11.2025

- [ ] 进行算子化设计（有优先级更高的事情打断了）
- [x] jolt测试（有优先级更高的事情打断了）
- [x] extension奇异性测试（排除一种算法）
- [ ] 关于求解器部分代码QT界面的实现

## [Week 27](./MA_WP_CH/WP27.md)   Time:10.11.2025 - 14.11.2025
- [x] extension奇异性测试（精确算法）
- [x] 建一个16closeloop模型
- [x] 查看和简化代码
- [ ] 冗余自由度
- [ ] 新论文
